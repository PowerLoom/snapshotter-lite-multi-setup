...
class SnapshotterSettings(BaseModel):
    ...
    SLOT_ID: str
    SNAPSHOT_CONFIG_REPO: HttpUrl = Field(
        default="https://github.com/powerloom/snapshotter-configs"
    )
    SNAPSHOT_CONFIG_REPO_BRANCH: str
    SNAPSHOTTER_COMPUTE_REPO: HttpUrl = Field(
        default="https://github.com/powerloom/snapshotter-computes"
    )
    ...
    NAMESPACE: str
    POWERLOOM_REPORTING_URL: HttpUrl = Field(
        default="https://nms-testnet-reporting.powerloom.io"
    )
    PROST_CHAIN_ID: str
